...
public class Doctor extends HttpServlet {
     ...
     */
       ...
       @EJB
       private SimpleDoctor simple1;
       
       @EJB
       private SimpleSession simple2;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String sym=request.getParameter("symptom");
            
            String dis=request.getParameter("disease");
            
            String cure=request.getParameter("cure");
            
            String doctor_id=simple2.getDoctorId();
            
            String message=simple1.addData(sym,dis,cure,doctor_id);
